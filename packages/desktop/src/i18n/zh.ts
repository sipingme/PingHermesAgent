...
export const zh: Translations = {
  ...
  boot: {
    ...
    steps: {
      ...
      startingHermesDesktop: '正在启动 PingHermesAgent…'
    },
    errors: {
      backgroundExited: 'PingHermesAgent 后台进程已退出。',
      backgroundExitedDuringStartup: 'PingHermesAgent 后台进程在启动期间退出。',
  ...
  notifications: {
    ...
    errors: {
      ...
      methodNotAllowed: '桌面后端拒绝了该请求(405 Method Not Allowed)。请尝试重启 PingHermesAgent。',
